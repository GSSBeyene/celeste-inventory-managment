...
('Fruit Salad', 'appetizer', 350.00, 140.00, 'Fresh strawberry, orange, apple, mango, papaya with syrup', ARRAY['strawberry', 'orange', 'apple', 'mango', 'papaya', 'syrup'], ARRAY[]::TEXT[], 8, true),
...
('Grilled Chicken', 'main', 650.00, 280.00, 'Well marinated chicken thigh grilled & served with rice', ARRAY['chicken', 'rice', 'marinade'], ARRAY[]::TEXT[], 35, true),
('Stir Fried Chicken', 'main', 620.00, 260.00, 'Fried cubes of chicken & cooked vegetable served with rice & prime', ARRAY['chicken', 'vegetables', 'rice'], ARRAY[]::TEXT[], 25, true),
('Roasted Chicken', 'main', 680.00, 300.00, 'Well marinated chicken & served with rice & prime', ARRAY['chicken', 'rice', 'marinade'], ARRAY[]::TEXT[], 40, true),
('Fried Chicken', 'main', 600.00, 250.00, 'Warmed chicken & served rice with vegetable', ARRAY['chicken', 'rice', 'vegetables'], ARRAY[]::TEXT[], 30, true),
('Roasted Lamb', 'main', 750.00, 350.00, 'Well marinated lamb served with brown sauce rice with vegetable', ARRAY['lamb', 'rice', 'vegetables', 'brown sauce'], ARRAY[]::TEXT[], 45, true),
('Pan Flake', 'main', 720.00, 320.00, 'Well marinated beef fried', ARRAY['beef', 'marinade'], ARRAY[]::TEXT[], 35, true),
...
('Fresh Orange Juice', 'beverage', 150.00, 50.00, 'Fresh squeezed orange juice', ARRAY['orange'], ARRAY[]::TEXT[], 3, true),
('Fresh Strawberry Juice', 'beverage', 160.00, 55.00, 'Fresh strawberry juice', ARRAY['strawberry'], ARRAY[]::TEXT[], 5, true),
('Fresh Papaya Juice', 'beverage', 140.00, 45.00, 'Fresh papaya juice', ARRAY['papaya'], ARRAY[]::TEXT[], 4, true),
('Fresh Mango Juice', 'beverage', 170.00, 60.00, 'Fresh mango juice', ARRAY['mango'], ARRAY[]::TEXT[], 5, true),
('Fresh Watermelon Juice', 'beverage', 130.00, 40.00, 'Fresh watermelon juice', ARRAY['watermelon'], ARRAY[]::TEXT[], 3, true),
('Fresh Avocado Juice', 'beverage', 180.00, 65.00, 'Fresh avocado juice', ARRAY['avocado'], ARRAY[]::TEXT[], 5, true),
('Special Juice Mix', 'beverage', 200.00, 75.00, 'Fresh strawberry, avocado, mango and papaya mix', ARRAY['strawberry', 'avocado', 'mango', 'papaya'], ARRAY[]::TEXT[], 8, true);